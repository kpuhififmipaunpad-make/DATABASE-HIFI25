...
module.exports = {
  ...
  // === FIX: Hilangkan semua callback Mongoose ===
  actionProfile: async (req, res) => {
    try {
      const payload = {
        username: req.body.username,
        // password: req.body.password, // tidak di-update di sini
        nama: req.body.nama,
        npm: req.body.npm,
        ttl: req.body.ttl,
        tgl: req.body.tgl,
      ...
      // Cek username sudah dipakai user lain (kecuali dirinya)
  ...
  // === FIX: gunakan Promise/async untuk bcrypt & Mongoose ===
